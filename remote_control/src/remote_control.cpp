...
bool RemoteControl::updateParams(std_srvs::Empty::Request& req, std_srvs::Empty::Response& res)
{
    ...
    get_param_ok = nh_local_.param<double>("arm_MAX_XYspeed", p_arm_MAX_XYspeed_, 1000.0);  // [mm/s]
    get_param_ok = nh_local_.param<double>("arm_MAX_Zspeed", p_arm_MAX_Zspeed_, 1000.0);    // [mm/s]
